...
st.set_page_config(
	page_title = "Learning Classification Orange",
	page_icon = ":tangerine:"
)

model = joblib.load("Model_Classification_Orange.joblib")

st.title(":tangerine: Learning Classification Orange")
...
st.divider()
st.caption("Dibuat dengan :tangerine: oleh **Faishal**")
